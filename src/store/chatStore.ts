...
// serializable and doesn't need to survive a reload.
...
/**
 * Ambil teks murni dari MessageContent.
 */
      ...
      return {
        ...
        createConversation: (providerId, model) => {
          ...
          const defaultProvider =
            get().providers.find((p) => p.isDefault && p.isActive) ||
            get().providers.find((p) => p.isActive);
        ...
        setDefaultProvider: (id) => {
          set((state) => ({
            providers: state.providers.map((p) => ({ ...p, isDefault: p.id === id })),
          }));
        },
        ...
        // ============================================================
        // SEND MESSAGE (with attachments: images + text/ZIP)
        // ============================================================
